...
const ActionItem = ({ product }) => {
    ...
    const buyNow = async () => {
        let response = await payUsingPaytm({ amount: 500, email: 'manoj123@gmail.com'});
        let information = {
    ...
    return (
        <LeftContainer>
          <Box style={{ padding: '15px 20px', border: '1px solid #f0f0f0', marginBottom: 10}}>
             ...
             <StyleButton variant="contained" onClick={() => buyNow()} style={{background: '#fb641b' }}><Flash />Buy Now</StyleButton>
        </LeftContainer>
    )
}
